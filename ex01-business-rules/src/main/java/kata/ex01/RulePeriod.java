...
public class RulePeriod {
    ...
    public boolean isIn(HighwayDrive drive) {
        ...
        LocalDateTime start = LocalDateTime.of(LocalDate.from(drive.getEnteredAt().plusDays(offset)), startTime);
        LocalDateTime end = LocalDateTime.of(LocalDate.from(drive.getExitedAt().plusDays(offset)), endTime);
